package com.hdfcbank.nilrouter.repository;
...
@Repository
@EnableCaching
public class TransformerConfigRepository {

    @Autowired
    private NamedParameterJdbcTemplate namedParameterJdbcTemplate;

    public void saveDataInMsgEventTracker(MsgEventTracker msgEventTracker) {
        String sql = "INSERT INTO networkil.msg_event_tracker (msg_id, source, target, flow_type, msg_type, original_req, original_req_count, consolidate_amt, intermediate_req, intemdiate_count, status, created_time, modified_timestamp) " +
                "VALUES (:msg_id, :source, :target, :flow_type, :msg_type, (XMLPARSE(CONTENT :original_req)), :original_req_count, :consolidate_amt, :intermediate_req, :intemdiate_count, :status, :created_time, :modified_timestamp )";
        ...
        params.addValue("original_req", msgEventTracker.getOriginalReq());
    ...
    public void saveAllTransactionAudits(List<TransactionAudit> transactionAudits) {
        String sql = "INSERT INTO networkil.transaction_audit (" +
